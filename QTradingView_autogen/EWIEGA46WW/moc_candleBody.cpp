...
namespace {
struct qt_meta_stringdata_candleBody_t {
    uint offsetsAndSizes[2];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_candleBody_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_candleBody_t qt_meta_stringdata_candleBody = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_candleBody[] = {
...
Q_CONSTINIT const QMetaObject candleBody::staticMetaObject = { {
    ...
    qt_meta_stringdata_candleBody.offsetsAndSizes,
    qt_meta_data_candleBody,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_candleBody_t,
        // Q_OBJECT / Q_GADGET
...
void *candleBody::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_candleBody.stringdata0))
