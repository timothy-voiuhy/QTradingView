...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGraphingViewENDCLASS_t qt_meta_stringdata_CLASSGraphingViewENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(39, 16)   // "setVerticalScale"
    },
    "GraphingView",
    "setHorizontalScale",
    "",
...
void GraphingView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GraphingView *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->setHorizontalScale((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->setVerticalScale((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject *GraphingView::metaObject() const
{
...
int GraphingView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
