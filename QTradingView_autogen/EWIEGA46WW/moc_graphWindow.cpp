...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_GraphWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_GraphWindow_t qt_meta_stringdata_GraphWindow = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_GraphWindow[] = {
...
Q_CONSTINIT const QMetaObject GraphWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_GraphWindow.offsetsAndSizes,
