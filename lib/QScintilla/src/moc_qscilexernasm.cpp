...
namespace {
struct qt_meta_stringdata_QsciLexerNASM_t {
    uint offsetsAndSizes[2];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerNASM_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerNASM_t qt_meta_stringdata_QsciLexerNASM = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerNASM[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerNASM::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerNASM.offsetsAndSizes,
    qt_meta_data_QsciLexerNASM,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerNASM_t,
        // Q_OBJECT / Q_GADGET
...
void *QsciLexerNASM::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerNASM.stringdata0))
