...
Q_CONSTINIT static const qt_meta_stringdata_QsciScintillaQt_t qt_meta_stringdata_QsciScintillaQt = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciScintillaQt[] = {
