...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerCSS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerCSS_t qt_meta_stringdata_QsciLexerCSS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerCSS[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerCSS::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerCSS.offsetsAndSizes,
    qt_meta_data_QsciLexerCSS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerCSS_t,
        // Q_OBJECT / Q_GADGET
