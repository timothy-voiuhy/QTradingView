...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerYAML_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerYAML_t qt_meta_stringdata_QsciLexerYAML = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerYAML[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerYAML::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerYAML.offsetsAndSizes,
    qt_meta_data_QsciLexerYAML,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerYAML_t,
        // Q_OBJECT / Q_GADGET
