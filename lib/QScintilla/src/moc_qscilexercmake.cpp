...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerCMake_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerCMake_t qt_meta_stringdata_QsciLexerCMake = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerCMake[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerCMake::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerCMake.offsetsAndSizes,
    qt_meta_data_QsciLexerCMake,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerCMake_t,
        // Q_OBJECT / Q_GADGET
