...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerFortran_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerFortran_t qt_meta_stringdata_QsciLexerFortran = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerFortran[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerFortran::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerFortran.offsetsAndSizes,
    qt_meta_data_QsciLexerFortran,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerFortran_t,
        // Q_OBJECT / Q_GADGET
