...
namespace {
struct qt_meta_stringdata_QsciLexerTekHex_t {
    uint offsetsAndSizes[2];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerTekHex_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerTekHex_t qt_meta_stringdata_QsciLexerTekHex = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerTekHex[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerTekHex::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerTekHex.offsetsAndSizes,
    qt_meta_data_QsciLexerTekHex,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerTekHex_t,
        // Q_OBJECT / Q_GADGET
...
void *QsciLexerTekHex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerTekHex.stringdata0))
