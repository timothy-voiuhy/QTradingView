...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerCustom_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerCustom_t qt_meta_stringdata_QsciLexerCustom = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerCustom[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerCustom::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerCustom.offsetsAndSizes,
    qt_meta_data_QsciLexerCustom,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerCustom_t,
        // Q_OBJECT / Q_GADGET
