...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerPOV_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerPOV_t qt_meta_stringdata_QsciLexerPOV = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerPOV[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerPOV::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerPOV.offsetsAndSizes,
    qt_meta_data_QsciLexerPOV,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerPOV_t,
        // Q_OBJECT / Q_GADGET
