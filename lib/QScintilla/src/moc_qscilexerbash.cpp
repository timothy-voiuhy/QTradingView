...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerBash_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerBash_t qt_meta_stringdata_QsciLexerBash = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerBash[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerBash::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerBash.offsetsAndSizes,
    qt_meta_data_QsciLexerBash,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerBash_t,
        // Q_OBJECT / Q_GADGET
