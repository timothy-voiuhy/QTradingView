...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerIDL_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerIDL_t qt_meta_stringdata_QsciLexerIDL = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerIDL[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerIDL::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerIDL.offsetsAndSizes,
    qt_meta_data_QsciLexerIDL,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerIDL_t,
        // Q_OBJECT / Q_GADGET
