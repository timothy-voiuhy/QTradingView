...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerRuby_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerRuby_t qt_meta_stringdata_QsciLexerRuby = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerRuby[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerRuby::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerRuby.offsetsAndSizes,
    qt_meta_data_QsciLexerRuby,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerRuby_t,
        // Q_OBJECT / Q_GADGET
