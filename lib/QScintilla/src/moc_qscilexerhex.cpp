...
namespace {
struct qt_meta_stringdata_QsciLexerHex_t {
    uint offsetsAndSizes[2];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerHex_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerHex_t qt_meta_stringdata_QsciLexerHex = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerHex[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerHex::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerHex.offsetsAndSizes,
    qt_meta_data_QsciLexerHex,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerHex_t,
        // Q_OBJECT / Q_GADGET
...
void *QsciLexerHex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerHex.stringdata0))
