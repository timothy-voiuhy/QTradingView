...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerOctave_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerOctave_t qt_meta_stringdata_QsciLexerOctave = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerOctave[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerOctave::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerOctave.offsetsAndSizes,
    qt_meta_data_QsciLexerOctave,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerOctave_t,
        // Q_OBJECT / Q_GADGET
