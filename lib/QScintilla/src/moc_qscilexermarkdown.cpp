...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerMarkdown_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerMarkdown_t qt_meta_stringdata_QsciLexerMarkdown = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerMarkdown[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerMarkdown::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerMarkdown.offsetsAndSizes,
    qt_meta_data_QsciLexerMarkdown,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerMarkdown_t,
        // Q_OBJECT / Q_GADGET
