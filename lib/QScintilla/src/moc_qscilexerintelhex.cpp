...
namespace {
struct qt_meta_stringdata_QsciLexerIntelHex_t {
    uint offsetsAndSizes[2];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerIntelHex_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerIntelHex_t qt_meta_stringdata_QsciLexerIntelHex = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerIntelHex[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerIntelHex::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerIntelHex.offsetsAndSizes,
    qt_meta_data_QsciLexerIntelHex,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerIntelHex_t,
        // Q_OBJECT / Q_GADGET
...
void *QsciLexerIntelHex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerIntelHex.stringdata0))
