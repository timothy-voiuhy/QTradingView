...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerMakefile_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerMakefile_t qt_meta_stringdata_QsciLexerMakefile = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerMakefile[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerMakefile::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerMakefile.offsetsAndSizes,
    qt_meta_data_QsciLexerMakefile,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerMakefile_t,
        // Q_OBJECT / Q_GADGET
