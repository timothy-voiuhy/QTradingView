...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerXML_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerXML_t qt_meta_stringdata_QsciLexerXML = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerXML[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerXML::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerXML.offsetsAndSizes,
    qt_meta_data_QsciLexerXML,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerXML_t,
        // Q_OBJECT / Q_GADGET
