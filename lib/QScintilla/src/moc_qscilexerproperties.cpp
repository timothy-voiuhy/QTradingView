...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerProperties_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerProperties_t qt_meta_stringdata_QsciLexerProperties = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerProperties[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerProperties::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerProperties.offsetsAndSizes,
    qt_meta_data_QsciLexerProperties,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerProperties_t,
        // Q_OBJECT / Q_GADGET
