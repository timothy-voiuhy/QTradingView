...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerDiff_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerDiff_t qt_meta_stringdata_QsciLexerDiff = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerDiff[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerDiff::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerDiff.offsetsAndSizes,
    qt_meta_data_QsciLexerDiff,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerDiff_t,
        // Q_OBJECT / Q_GADGET
