...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerVerilog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerVerilog_t qt_meta_stringdata_QsciLexerVerilog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerVerilog[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerVerilog::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerVerilog.offsetsAndSizes,
    qt_meta_data_QsciLexerVerilog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerVerilog_t,
        // Q_OBJECT / Q_GADGET
