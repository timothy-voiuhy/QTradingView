...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerJava_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerJava_t qt_meta_stringdata_QsciLexerJava = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerJava[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerJava::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerJava.offsetsAndSizes,
    qt_meta_data_QsciLexerJava,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerJava_t,
        // Q_OBJECT / Q_GADGET
