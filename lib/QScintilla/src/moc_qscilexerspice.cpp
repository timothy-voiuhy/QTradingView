...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerSpice_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerSpice_t qt_meta_stringdata_QsciLexerSpice = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerSpice[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerSpice::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerSpice.offsetsAndSizes,
    qt_meta_data_QsciLexerSpice,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerSpice_t,
        // Q_OBJECT / Q_GADGET
