...
namespace {
struct qt_meta_stringdata_QsciLexerMASM_t {
    uint offsetsAndSizes[2];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerMASM_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerMASM_t qt_meta_stringdata_QsciLexerMASM = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerMASM[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerMASM::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerMASM.offsetsAndSizes,
    qt_meta_data_QsciLexerMASM,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerMASM_t,
        // Q_OBJECT / Q_GADGET
...
void *QsciLexerMASM::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerMASM.stringdata0))
