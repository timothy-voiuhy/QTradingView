...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerJavaScript_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerJavaScript_t qt_meta_stringdata_QsciLexerJavaScript = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerJavaScript[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerJavaScript::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerJavaScript.offsetsAndSizes,
    qt_meta_data_QsciLexerJavaScript,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerJavaScript_t,
        // Q_OBJECT / Q_GADGET
