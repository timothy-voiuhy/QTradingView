...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerPython_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerPython_t qt_meta_stringdata_QsciLexerPython = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerPython[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerPython::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerPython.offsetsAndSizes,
    qt_meta_data_QsciLexerPython,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerPython_t,
        // Q_OBJECT / Q_GADGET
