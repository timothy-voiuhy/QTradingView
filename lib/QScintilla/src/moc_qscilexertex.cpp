...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerTeX_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerTeX_t qt_meta_stringdata_QsciLexerTeX = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerTeX[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerTeX::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerTeX.offsetsAndSizes,
    qt_meta_data_QsciLexerTeX,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerTeX_t,
        // Q_OBJECT / Q_GADGET
