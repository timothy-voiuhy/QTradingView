...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerJSON_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerJSON_t qt_meta_stringdata_QsciLexerJSON = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerJSON[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerJSON::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerJSON.offsetsAndSizes,
    qt_meta_data_QsciLexerJSON,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerJSON_t,
        // Q_OBJECT / Q_GADGET
