...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerPascal_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerPascal_t qt_meta_stringdata_QsciLexerPascal = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerPascal[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerPascal::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerPascal.offsetsAndSizes,
    qt_meta_data_QsciLexerPascal,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerPascal_t,
        // Q_OBJECT / Q_GADGET
