...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerPostScript_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerPostScript_t qt_meta_stringdata_QsciLexerPostScript = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerPostScript[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerPostScript::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerPostScript.offsetsAndSizes,
    qt_meta_data_QsciLexerPostScript,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerPostScript_t,
        // Q_OBJECT / Q_GADGET
