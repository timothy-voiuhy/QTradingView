...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerEDIFACT_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerEDIFACT_t qt_meta_stringdata_QsciLexerEDIFACT = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerEDIFACT[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerEDIFACT::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerEDIFACT.offsetsAndSizes,
    qt_meta_data_QsciLexerEDIFACT,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerEDIFACT_t,
        // Q_OBJECT / Q_GADGET
