...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerFortran77_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerFortran77_t qt_meta_stringdata_QsciLexerFortran77 = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerFortran77[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerFortran77::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerFortran77.offsetsAndSizes,
    qt_meta_data_QsciLexerFortran77,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerFortran77_t,
        // Q_OBJECT / Q_GADGET
