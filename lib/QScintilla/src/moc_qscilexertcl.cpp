...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerTCL_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerTCL_t qt_meta_stringdata_QsciLexerTCL = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerTCL[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerTCL::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerTCL.offsetsAndSizes,
    qt_meta_data_QsciLexerTCL,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerTCL_t,
        // Q_OBJECT / Q_GADGET
