...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerCSharp_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerCSharp_t qt_meta_stringdata_QsciLexerCSharp = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerCSharp[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerCSharp::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerCSharp.offsetsAndSizes,
    qt_meta_data_QsciLexerCSharp,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerCSharp_t,
        // Q_OBJECT / Q_GADGET
