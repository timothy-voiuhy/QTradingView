...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerBatch_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QsciLexerBatch_t qt_meta_stringdata_QsciLexerBatch = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QsciLexerBatch[] = {
...
Q_CONSTINIT const QMetaObject QsciLexerBatch::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerBatch.offsetsAndSizes,
    qt_meta_data_QsciLexerBatch,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerBatch_t,
        // Q_OBJECT / Q_GADGET
